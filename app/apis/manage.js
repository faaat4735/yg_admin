...
export const shuabuVersionAd = createApi(`${shuabuUrl}/admin-version/ad-list`) // 获取版本列表
export const shuabuVersionAdDetail = createApi(`${shuabuUrl}/admin-version/ad-detail`) // 获取版本列表
// 运营位管理
